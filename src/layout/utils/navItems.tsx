...
export const navItems: INavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: '/agent/agent-payment',
        to: '/agent/agent-payment',
        label: 'Agent Payment List',
        icon: 'ic:twotone-list',
        name: 'AGENT_PAYMENT',
      },
    ],
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: '/report/account-transaction',
        to: '/report/account-transaction',
